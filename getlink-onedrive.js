function get_url(){  
var safe_redirect = "https://www.sushantkarn.com.np/?id=";
...
if (domain == undefined) {
        ...
        alert('Please enter a file sharing link from OneDrive including http:// or https://')
        }
...
document.getElementById("copy").value = "Copy Link";
}
